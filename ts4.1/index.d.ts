...
export interface Library {
     ...
     * @param funcs hash of [retType, [...argType], opts?: {abi?, promise?, async?, varargs?}]
     * @param lib hash that will be extended
     */
    new (libFile: string | null, funcs?: Record<string, [string | ref.Type, Array<string | ref.Type>, { abi?: number, promise?: boolean, async?: boolean, varargs?: boolean }?]>, lib?: object): any;
     ...
     * @param lib hash that will be extended
     */
    (libFile: string | null, funcs?: Record<string, [string | ref.Type, Array<string | ref.Type>, { abi?: number, promise?: boolean, async?: boolean, varargs?: boolean }?]>, lib?: object): any;
}
